import NodeHelper from "../../js/node_helper";
...
module.exports = NodeHelper.create({
  ...
  getRERPassages: async function (urlRER) {
    try {
      ...
      await page.goto(`${urlRER}${hours}%3A${minutes}&date=${date.toISOString().substring(0, 10)}&endTimeSlot=${parseInt(hours) + 1}%3A${minutes}`);
